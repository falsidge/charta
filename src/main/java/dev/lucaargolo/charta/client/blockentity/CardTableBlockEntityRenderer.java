...
public class CardTableBlockEntityRenderer implements BlockEntityRenderer<CardTableBlockEntity> {
    ...
    public static void drawCard(Deck deck, Card card, int packedLight, int packedOverlay, PoseStack poseStack, MultiBufferSource bufferSource, float x, float y, Vector3f normal) {
        ...
        if(IrisCompat.isPresent()) {
            ...
            glowConsumer.vertex(entry.pose(), (x+CardImage.WIDTH)/160f, y/160f, 0).color(1f, 1f, 1f, 1f).uv(1f, 1f).overlayCoords(packedOverlay).uv2(LightTexture.FULL_BRIGHT).normal(normal.x, normal.y, normal.z).endVertex();
            glowConsumer.vertex(entry.pose(), (x+CardImage.WIDTH)/160f, (y+CardImage.HEIGHT)/160f, 0).color(1f, 1f, 1f, 1f).uv(1f, 0f).overlayCoords(packedOverlay).uv2(LightTexture.FULL_BRIGHT).normal(normal.x, normal.y, normal.z).endVertex();
            glowConsumer.vertex(entry.pose(), x/160f, (y+CardImage.HEIGHT)/160f, 0).color(1f, 1f, 1f, 1f).uv(0f, 0f).overlayCoords(packedOverlay).uv2(LightTexture.FULL_BRIGHT).normal(normal.x, normal.y, normal.z).endVertex();
            glowConsumer.vertex(entry.pose(), x/160f, y/160f, 0).color(1f, 1f, 1f, 1f).uv(0f, 1f).overlayCoords(packedOverlay).uv2(LightTexture.FULL_BRIGHT).normal(normal.x, normal.y, normal.z).endVertex();
        }
        ...
        consumer.vertex(entry.pose(), (x+CardImage.WIDTH)/160f, y/160f, 0).color(1f, 1f, 1f, 1f).uv(1f, 1f).overlayCoords(packedOverlay).uv2(packedLight).normal(normal.x, normal.y, normal.z).endVertex();
        consumer.vertex(entry.pose(), (x+CardImage.WIDTH)/160f, (y+CardImage.HEIGHT)/160f, 0).color(1f, 1f, 1f, 1f).uv(1f, 0f).overlayCoords(packedOverlay).uv2(packedLight).normal(normal.x, normal.y, normal.z).endVertex();
        consumer.vertex(entry.pose(), x/160f, (y+CardImage.HEIGHT)/160f, 0).color(1f, 1f, 1f, 1f).uv(0f, 0f).overlayCoords(packedOverlay).uv2(packedLight).normal(normal.x, normal.y, normal.z).endVertex();
        consumer.vertex(entry.pose(), x/160f, y/160f, 0).color(1f, 1f, 1f, 1f).uv(0f, 1f).overlayCoords(packedOverlay).uv2(packedLight).normal(normal.x, normal.y, normal.z).endVertex();
    }
