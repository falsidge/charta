...
public class ModRenderType extends RenderType {
    ...
    private static final ShaderStateShard ENTITY_CARD_SHADER = new ShaderStateShard(() -> ChartaClient.ENTITY_CARD_SHADER);
    private static final ShaderStateShard IRON_LEASH_SHADER = new ShaderStateShard(() -> ChartaClient.IRON_LEASH_SHADER);
